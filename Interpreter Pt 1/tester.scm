...
(define testcases
 '(; part 1 tests
   ...
   ("tests/test12.javaish" error:uninitializedvariable)
   ("tests/test13.javaish" error:uninitializedvariable)
   ("tests/test14.javaish" error:variablealreadydeclared)
   ...
   ("tests/test2-5.javaish" error:invalidcommand)
   ;("tests/test2-6.javaish" 25)
   ("tests/test2-7.javaish" 21)
   ("tests/test2-8.javaish" 6)
   ("tests/test2-9.javaish" -1)
   ("tests/test2-10.javaish" 789)
   ("tests/test2-11.javaish" error:invalidcommand)
   ("tests/test2-12.javaish" error:invalidcommand)
   ("tests/test2-13.javaish" error:invalidcommand)
   ...
   ("tests/test2-19.javaish" error:invalidcommand)
